...
public class InnerClassesMain {
    ...
    private static void demonstrateMemberInnerClass() {
        ...
        // Get car brand using new method
        System.out.println("\n📍 Car Details:");
        ...
        engine.startEngine();
        System.out.println("   Engine Info: " + engine.getEngineInfo());
        ...
        // NEW: Complete car operation
        System.out.println("\n📍 Complete Car Operation:");
        car.operateCarCompletely();
    ...
    private static void demonstrateStaticInnerClass() {
        ...
        // NEW: Add car sales and demonstrate updated stats
        System.out.println("\n📍 Updating company statistics:");
        Step2_StaticInnerClass.addCarSale(25);
        Step2_StaticInnerClass.showCompanyStats();
        
        // NEW: Full demonstration
        System.out.println("\n📍 Comprehensive Static Inner Class Usage:");
        Step2_StaticInnerClass autoCompany = new Step2_StaticInnerClass();
        autoCompany.demonstrateFullStaticInnerClassUsage();
    ...
    private static void demonstrateLocalInnerClass() {
        ...
        // NEW: Multiple local inner classes
        System.out.println("\n📍 Multiple Local Inner Classes:");
        factory.demonstrateMultipleLocalInnerClasses();
        
        // NEW: Real-world car production
        System.out.println("\n📍 Real-world Scenario - Car Production Process:");
        factory.demonstrateCarProductionProcess();
    ...
    private static void demonstrateAnonymousInnerClass() {
        ...
        // NEW: Advanced chaining
        System.out.println("\n📍 EXAMPLE 6 - Advanced Anonymous Chaining:");
        anonymousDemo.demonstrateAdvancedAnonymousChaining();
        
        // NEW: Event listeners
        System.out.println("\n📍 EXAMPLE 7 - Real-world Event Listeners:");
        anonymousDemo.demonstrateEventListeners();
        
        // NEW: Builder pattern
        System.out.println("\n📍 EXAMPLE 8 - Anonymous with Builder Pattern:");
        anonymousDemo.demonstrateAnonymousWithBuilderPattern();
    ...
    private static void compareAnonymousVsLambda() {
        ...
        // NEW: Advanced lambda
        comparisonDemo.advancedLambdaComparison();
        
        // NEW: Method references
        comparisonDemo.demonstrateMethodReferences();
