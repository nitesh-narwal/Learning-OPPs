...
public class Step1_MemberInnerClass {
    ...
    // NEW: Get car brand - utility method to be used
    public String getCarBrand() {
        return carBrand;
    }
    
    // NEW: Get car price - utility method to be used
    public int getCarPrice() {
        return carPrice;
    }
    
    // NEW: Full car control method - demonstrates integration of inner classes
    public void operateCarCompletely() {
        ...
        // Setup radio system
        RadioSystem radio = this.new RadioSystem();
        radio.turnOn();
        radio.setVolume(80);
        radio.showStatus();
