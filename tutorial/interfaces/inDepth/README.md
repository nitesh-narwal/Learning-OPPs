...
### **Compile All Files**
```bash
cd /home/niku/Practice/me/niteshh/OPPs/tutorial/interfaces
javac *.java
```

### **Run Quick Test**
```bash
java me.niteshh.OPPs.tutorialterfaces.QuickTest
```

### **Run Lambda Demo**
```bash
java me.niteshh.OPPs.tutorialterfaces.LambdaExpressionDemo
```

### **Run Main Comprehensive Demo**
```bash
java me.niteshh.OPPs.tutorialterfaces.InterfaceMainClass
```
